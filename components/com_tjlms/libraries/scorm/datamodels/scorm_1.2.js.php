...
function SCORMapi() {
    ...
    var datamodel =  {
        ...
        'cmi.core.lesson_status':{'defaultvalue':'<?php echo isset($userscormdata->{'cmi.core.lesson_status'})?$userscormdata->{'cmi.core.lesson_status'}:'incomplete' ?>', 'format':CMIStatus, 'mod':'rw', 'writeerror':'405'},
             ...
             jQuery.ajax({
                ...
                error: function(xhr, textStatus, error)
                {
                    <?php if($this->jDebug == 1){ ?>
                        ...
                        console.log("Storing data error" + errorCode)
