...
if (empty($this->gateways))
{
	?>
		<div class="alert alert-danger">
			<?php	echo JText::_('COM_TJLMS_NOPAYMENT_GATEWAYS_CONFIGURED');?>
		</div>
	<?php
...
<script type="text/javascript">
	...
	{
		var r = confirm("<?php echo JText::_('COM_TJLMS_CANCEL_PROCESS',true); ?>");
					...
					<div id="MyWizard" class="wizard row">
						...
						<ol class="tjlms-steps-ol steps clearfix row" id="tjlms-steps">
							<li id="id_step_select_subsplan" data-target="#step_select_subsplan" class="active col-xs-4">
								...
								<span class="steps-title pl-10 hidden-phone hidden-tablet d-md-inline hidden-xs"><?php echo JText::_('COM_TJLMS_SELECT_SUBSCRIPTION_PLANS');?></span>
							...
							<li id="id_step_billing_info" class="col-xs-4" data-target="#step_billing_info">
								...
								<span class="steps-title pl-10 hidden-phone hidden-tablet d-md-inline hidden-xs"><?php echo JText::_('COM_TJLMS_SELECT_BILLING_STEP');?></span>
								<span class="chevron"></span>
							</li>

							<li id="id_step_payment_info" class="col-xs-4" data-target="#step_payment_info" id="payment-info-li">
								<span class="badge d-inline"><?php echo $step_no;$step_no++;?></span>
								<span class="steps-title pl-10 hidden-phone hidden-tablet d-md-inline hidden-xs"><?php echo JText::_('COM_TJLMS_PAYMENT_STEP');?></span>
								<span class="chevron"></span>
							</li>
						</ol>
					</div>
					...
					/*<div class="prev_next_wizard_actions">
						<div class="form-actions">
							<div class="col-xs-12 col-sm-8 col-md-9">
								<button id="btnWizardPrev" type="button" class="btn btn-prev pull-left" style="display:none;" > <i class="fa fa-arrow-circle-o-left" ></i><?php echo JText::_('COM_TJLMS_PREV_BUTTON'); ?></button>
							</div>
							<div class="col-xs-12 col-sm-2 col-md-1">
								<button id="tjlmscancel" type="button" class="btn btn-danger" onclick="cancelProcess()"><?php echo JText::_('COM_TJLMS_CANCEL');?></button>
							</div>
							<div class="col-xs-12 col-sm-2">
								<button id="btnWizardNext" type="button" class="btn btn-success" data-last="Finish" ><?php echo JText::_('COM_TJLMS_SAVE_AND_NEXT');?><i class="fa fa-arrow-circle-o-right"></i></button>
							</div>
						</div>
					</div>
					*/?>
