...
$document->addStyleSheet('components/com_tjlms/assets/css/tjlms.css');
...
<?php
	...
	<div class="modal-header">
		...
		<h3><?php echo JText::sprintf('COM_TJLMS_ENROLLED_USERS_FOR_COURSE',$this->courseInfo->title); ?>
	</div>
<?php } ?>
				...
				<thead>
					<tr>
						...
						<?php endif; ?>
							...
							<th class='left'>
							<?php echo JHtml::_('grid.sort',  'COM_TJLMS_ENROLMENT_USER_NAME', 'u.name', $listDirn, $listOrder); ?>
							</th>
							<?php if (!$courseId)
							{	?>
							<th class='left'>
							<?php echo JHtml::_('grid.sort',  'COM_TJLMS_MANAGEENROLLMENTS_COURSE_ID', 'a.course_id', $listDirn, $listOrder); ?>
							</th>
							<?php } ?>
							<th class='left'>
							<?php echo JHtml::_('grid.sort',  'COM_TJLMS_ENROLMENT_USER_USERNAME', 'u.username', $listDirn, $listOrder); ?>
							</th>
					...
					else
					{
						...
						<td>
								<a class="modal studentsReport" onclick=opentjlmsSqueezeBox("<?php echo $studenCoursereport; ?>") >
									<?php echo JText::_( 'COM_TJLMS_STUDENT_COURSE_REPORT_DASHBOARD' ); ?>
								</a>
						</td>
			<?php	}
					?>
