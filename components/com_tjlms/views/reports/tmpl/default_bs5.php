...
JHTML::_('bootstrap.renderModal', 'a.tjmodal');
?>
...
<div class="techjoomla-bootstrap">
	<div class="com_tjlms_content">
		<table class="table table-bordered tjlms-table" width="100%">
			<thead>
				<tr>
					<th class="border-top-blue greyish center"><?php echo Text::_( 'COM_TJLMS_COURSE_LESSON' ); ?></th>
					<th class="border-top-red greyish center"><?php echo Text::_( 'COM_TJLMS_ATTEMPTS' ); ?></th>
					<th class="border-top-green greyish center"><?php echo Text::_( 'COM_TJLMS_SCORE' ); ?></th>
					<th class="border-top-blue greyish center"><?php echo Text::_( 'COM_TJLMS_LESSON_STATUS' ); ?></th>
				</tr>
			</thead>
			<?php
			if(!empty($this->row))
			...
			{
				echo "<tr><td colspan='4' class='center'>".Text::_('COM_TJLMS_COURSE_REPORT_NOT_FOUND')."</td></tr>";
			}
			?>
		</table>
	</div>
