...
?>
					...
					<div class="row-fluid">
						<div class="span6">
							<div class="control-group row-fluid">
								...
								<div class="controls text-info"><?php echo Text::_('COM_TJLMS_FORM_DESC_MINIMUM_NO_OF_ASSESSMENT_NOTE'); ?></div>
	...
	<input type="hidden" name="task" value="lessonform.saveassessment"/>
</form>
