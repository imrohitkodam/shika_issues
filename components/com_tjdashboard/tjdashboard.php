...
JLoader::registerPrefix('Tjdashboard', JPATH_ROOT . '/components/com_tjdashboard');
JLoader::register('TjdashboardController', JPATH_ROOT . '/components/com_tjdashboard/controller.php');
...
// Execute the task.
$controller = new TjdashboardController();
