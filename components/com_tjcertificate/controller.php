...
JLoader::load(JPATH_ADMINISTRATOR . '/components/com_tjcertificate/includes/tjcertificate');
JLoader::register('TjCertificateHelper', JPATH_ADMINISTRATOR . '/components/com_tjcertificate/helpers/tjcertificate.php');
