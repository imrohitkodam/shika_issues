		...
		<div class="js-stools-container-bar">
			<?php if ($filters) : ?>
				<label for="filter_search" class="element-invisible"
				       aria-invalid="false"><?php echo Text::_('COM_JLIKE_SEARCH_FILTER_SUBMIT'); ?></label>

				<div class="btn-wrapper input-append">
					<?php echo $filters['filter_search']->input; ?>
					<button type="submit" class="btn hasTooltip" title=""
					        data-original-title="<?php echo Text::_('COM_JLIKE_SEARCH_FILTER_SUBMIT'); ?>">
				...
				<div class="btn-wrapper hidden-phone">
					<button type="button" class="btn hasTooltip js-stools-btn-filter" title=""
					        data-original-title="<?php echo Text::_('COM_JLIKE_SEARCH_TOOLS_DESC'); ?>">
						<?php echo Text::_('COM_JLIKE_SEARCH_TOOLS'); ?> <i class="caret"></i>
					</button>
				</div>

				<div class="btn-wrapper">
					<button type="button" class="btn hasTooltip js-stools-btn-clear" title=""
					        data-original-title="<?php echo Text::_('COM_JLIKE_SEARCH_FILTER_CLEAR'); ?>">
						<?php echo Text::_('COM_JLIKE_SEARCH_FILTER_CLEAR'); ?>
					</button>
				</div>
			<?php endif; ?>
		</div>
