	...
	<hr/>
		...
		<form action="" method="post" name="adminForm" id="adminForm">
			<div class="input-append jlike-search-like btn-toolbar">
				...
				<button type="button" onclick="this.form.submit();" class="btn tip hasTooltip" data-original-title="<?php echo Text::_('COM_JLIKE_ALLANNOTATIONS_SEARCH_BTN_TOOLTIP'); ?>">
					<i class="fa fa-search"></i>
				</button>

				<button onclick="document.getElementById('filter_search_likecontent').value='';this.form.submit();" type="button" class="btn tip hasTooltip" data-original-title="<?php echo Text::_('COM_JLIKE_ALLANNOTATIONS_CLEAR_BTN_TOOLTIP'); ?>">
					<i class="fa fa-times"></i>
				</button>
			</div>

			<div class="jlike-search-like pull-right">
				<?php
