...
$componentPath = JPATH_ROOT . '/components/com_api';
$library_path = $componentPath . '/libraries';
...
JLoader::discover('API', $componentPath . '/libraries/exceptions');
...
$c_path = $componentPath . '/controllers/' . strtolower($c) . '.php';
