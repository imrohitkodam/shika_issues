...
class Box_View_API
{
	 ...
	 *
	 * @param   string  $api_key  API Key for your Box View Application.
	 *
	 ...
	 *
	 * @param   Box_View_Document  &$doc    Box_View_Document
	 * @param   array              $params  duration -- The duration in minutes until the session expires. (default=60)
	 *  expires_at -- The timestamp at which the session should expire.
	 *
	 * @return  object Returns session response object.
	 *
	 * @throws Box_View_Exception
	 */
	 ...
	 *
	 * @param   Box_View_Document  &$doc  Box_View_Document
	 * @param   string             $ext   Extension of the content to retrieve. Valid extensions are 'zip' and 'pdf'.
	 ...
	 * @param   Box_View_Document  &$doc  Box_View_Document
	 *
	 * @return  mixed Returns the document.
	 */
	 ...
	 * @param   Box_View_Document  &$doc  Box_View_Document
	 *
	 * @return  mixed Returns the raw PDF code.
	 */
	 ...
	 * @param   Box_View_Document  &$doc  Box_View_Document
	 *
	 * @return  mixed  Returns the raw Zip file.
	 */
	 ...
	 *
	 * @param   Box_View_Document  &$doc    doc
	 * @param   int                $width   width
	 * @param   int                $height  height
	 *
	 * @return  mixed Returns the raw Png file.
	 */
	 ...
	 *
	 * @return  string  Returns valid JSON.
	 */
	 ...
	 *
	 * @param   array  $curl_params  Array of CURLOPT params.
	 *
	 * @throws  Box_View_Exception
	 *
	 ...
	 * @param   Box_View_Document  &$doc  Box_View_Document
	 *
	 * @return  object Returns the response from the server.
	 *
	 * @throws  Box_View_Exception
	 */
	public function update(Box_View_Document &$doc)
	{
		...
		$curl_params[CURLOPT_POSTFIELDS]    = $this->formatData(
													array(
														'name' => $doc->name
													)
												);
	 ...
	 *
	 * @param   Box_View_Document  &$doc      Box_View_Document
	 * @param   array|object       $metadata  Array or object of metadata with key values matching document properties.
	 *
	 * @return  Void
	 */
	 ...
	 *
	 * @param   array  &$docs  Array of Box_View_Document instances.
	 *
	 * @return  array Returns array of responses received from deleting.
	 *
	 * @throws Box_View_Exception
	 */
	 ...
	 * @param   array  &$docs  Array of Box_View_Document instances.
	 *
	 * @return  array  Returns array of responses received from uploading.
	 *
	 * @throws Box_View_Exception
	 */
	...
	public function upload(Box_View_Document &$doc)
	{
		...
		if (!empty($doc->file_path))
		{
			...
			{
				$post_fields['file'] = new CurlFile($doc->file_path);
			}
	 ...
	 *
	 * @return  object Returns the metadata
	 *
	 * @throws Box_View_Exception
	 */
