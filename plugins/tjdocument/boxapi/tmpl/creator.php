...
<?php	}  ?>
	...
	<div class="control-group">
		<div class="control-label"><label title="<?php echo Text::_('COM_TJLMS_UPLOAD_FORMAT');?>"><?php echo Text::_("COM_TJLMS_UPLOAD_FORMAT") ?></label></div>
					...
					<div class="input-append">
						<div class="uneditable-input span4">
							<span class="fileupload-preview">
								<?php echo Text::sprintf('COM_TJLMS_UPLOAD_FILE_WITH_EXTENSION', 'pdf, doc, docx, ppt, pptx', $allowedFileSize);?>
							</span>
						</div>
...
<script type="text/javascript">
	...
	function validatedocumentboxapi(formid,format,subformat,media_id)
	{
		...
		if(media_id == 0)
		{
			...
			{
				var res = {check: 0, message: "<?php echo Text::_('PLG_TJDOC_BOXAPI_FILE_MISSING');?>"};
			}
		}
		return res;
	}
