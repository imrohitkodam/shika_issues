...
(function (jQuery) {
    ...
    jQuery.contentbuilder = function (element, options) {
                ...
                jQuery.get(this.settings.snippetFile, function (data) {
                    ...
                    jQuery('<div/>').html(data).children('div').each(function () {
                        ...
                        if(bUseSnippetsFilter){
                            htmlThumbs += '<div style="display:none" title="Snippet ' + i + '" data-snip="' + i + '" data-cat="' + jQuery(this).data("cat") + '"><img src="' + jQuery(this).data("thumb") + '" /></div>';
                        } else {
                            htmlThumbs += '<div title="Snippet ' + i + '" data-snip="' + i + '" data-cat="' + jQuery(this).data("cat") + '"><img src="' + jQuery(this).data("thumb") + '" /></div>';
                        }                        
                    ...
                    if(bUseSnippetsFilter){
                        ...
                        jQuery($element.data('contentbuilder').settings.snippetList + ' > div').each(function () {
                            for(var j=0;j<jQuery(this).attr('data-cat').split(',').length;j++){
                                if(jQuery(this).attr('data-cat').split(',')[j] == 0){
        ...
        this.applyBehavior = function () {
            ...
            $element.contenteditor({ fileselect: fileselect, editable: selectable, colors: colors, editMode: editMode, toolbar: toolbar });
            ...
            if (editable == '') {
                ...
                $element.find(editable).each(function () {
                    ...
                    if (editMode == 'default') {
                        ...
                        //do nothing (parent will set ediatble)
