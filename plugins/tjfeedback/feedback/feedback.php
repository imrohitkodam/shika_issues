 ...
 * @since  1.0.0
 */
class PlgTjfeedbackfeedback extends FormHelper
{
	/**
	 ...
	 * @since 1.0.0
	 */
	public function onGetSubFormat_tjfeedbackContentInfo($config=array('feedback'))
	{
		...
		$obj 			= array();
		$obj['name']	= $this->params->get('plugin_name', 'feedback');
		$obj['id']		= $this->_name;
		$obj['assessment'] = 0;
	 ...
	 * @since 1.0.0
	 */
	public function onGetSubFormat_feedbackContentHTML($mod_id , $lesson_id, $lesson, $comp_params, $form_id)
	{
	 ...
	 * @since 1.0.0
	 */
	public function onfeedbackrenderPluginHTML($config)
	{
		$input = Factory::getApplication()->input;
		$mode = $input->get('mode', '', 'STRING');
		$config['plgtask'] = 'feedback_updatedata';
	...
	public function onAdditionalfeedbackFormatCheck($lessonId, $mediaObj)
	{
	 ...
	 * @since 1.0.0
	 */
	public function OnAfterfeedbackFormatUploaded($lessonFormatData)
	{
	 ...
	 * @since 1.0.0
	 */
	public function onGetAdditionalfeedbackData($lessonId, $mediaData)
	{
