	var tjexercise = {
		...
		exerciseSpecificMetadata: function(form_id)
		{
			var lesson_format_form = techjoomla.jQuery('#lesson-format-form_'+form_id);

			var time_duration = techjoomla.jQuery("input[name='lesson_format[exercise][time_duration]']", lesson_format_form).val();

			var time_finished_duration = techjoomla.jQuery("input[name='lesson_format[exercise][time_finished_duration]']", lesson_format_form).val();
