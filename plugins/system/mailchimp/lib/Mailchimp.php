<?php
require_once JPATH_SITE . '/plugins/system/mailchimp/lib/Folders.php';
require_once JPATH_SITE . '/plugins/system/mailchimp/lib/Templates.php';
require_once JPATH_SITE . '/plugins/system/mailchimp/lib/Users.php';
require_once JPATH_SITE . '/plugins/system/mailchimp/lib/Helper.php';
require_once JPATH_SITE . '/plugins/system/mailchimp/lib/Mobile.php';
require_once JPATH_SITE . '/plugins/system/mailchimp/lib/Conversations.php';
require_once JPATH_SITE . '/plugins/system/mailchimp/lib/Ecomm.php';
require_once JPATH_SITE . '/plugins/system/mailchimp/lib/Neapolitan.php';
require_once JPATH_SITE . '/plugins/system/mailchimp/lib/Lists.php';
require_once JPATH_SITE . '/plugins/system/mailchimp/lib/Campaigns.php';
require_once JPATH_SITE . '/plugins/system/mailchimp/lib/Vip.php';
require_once JPATH_SITE . '/plugins/system/mailchimp/lib/Reports.php';
require_once JPATH_SITE . '/plugins/system/mailchimp/lib/Gallery.php';
require_once JPATH_SITE . '/plugins/system/mailchimp/lib/Goal.php';
require_once JPATH_SITE . '/plugins/system/mailchimp/lib/Exceptions.php';
