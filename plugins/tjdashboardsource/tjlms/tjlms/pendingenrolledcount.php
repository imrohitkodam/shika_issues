...
class TjlmsPendingenrolledcountDatasource
{
	public $dataSourceName = "PLG_TJDASHBOARDSOURCE_TJLMS_PENDING_ENROLLED_COUNT";
	/**
	...
	public function getData()
	{
		...
		try
		{
			...
			$query->where($db->quoteName('eu.user_id') . ' = ' . $user->id);
