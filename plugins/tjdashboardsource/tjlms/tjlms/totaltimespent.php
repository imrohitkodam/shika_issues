...
class TjlmsTotaltimespentDatasource
{
	public $dataSourceName = "PLG_TJDASHBOARDSOURCE_TJLMS_TOTAL_TIME_SPENT";
	/**
	...
	public function getData()
	{
		try
		{
			...
			$totalSpentTime = $tjlmsTrackingHelperObj->getTotalTimeSpent($user->id);
			$totalSpentTime = (!empty($totalSpentTime)?$totalSpentTime:'00:00:00');
