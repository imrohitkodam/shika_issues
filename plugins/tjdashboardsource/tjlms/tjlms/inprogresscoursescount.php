...
class TjlmsInprogresscoursescountDatasource
{
	public $dataSourceName = "PLG_TJDASHBOARDSOURCE_TJLMS_IN_PROGRESS_COURSES_COUNT";
	/**
	...
	public function getData()
	{
		...
		try
		{
			// Get count of inprogress courses for the user
			$db = Factory::getDbo();
			...
			$query->select('COUNT(ct.id) as totalInCompletedCourses');
			...
			$query->where($db->quoteName('ct.status') . ' = "I"');
