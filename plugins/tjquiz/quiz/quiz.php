 ...
 * @since  1.0.0
 */
class PlgTjquizquiz extends FormHelper
{
	/**
	 ...
	 * @since 1.0.0
	 */
	public function onGetSubFormat_tjquizContentInfo($config=array('quiz'))
	{
	 ...
	 * @since 1.0.0
	 */
	public function onGetSubFormat_quizContentHTML($mod_id, $lesson_id, $lesson, $comp_params, $form_id)
	{
	 ...
	 * @since 1.0.0
	 */
	public function onquizrenderPluginHTML($config)
	{
	...
	public function onAdditionalquizFormatCheck($lessonId, $mediaObj)
	{
	 ...
	 * @since 1.0.0
	 */
	public function OnAfterquizFormatUploaded($lessonFormatData)
	{
	 ...
	 * @since 1.0.0
	 */
	public function onGetAdditionalquizData($lessonId, $mediaData)
	{
	 ...
	 * @since 1.3.39
	 */
	public function onisPassable_tjquiz()
	{
		return true;
	}
}
