	...
	<div class="panel panel-default br-0">
		<div class="panel-heading">
			<span class="panel-heading__title">
				...
				<span><?php echo Text::_('PLG_TJLMSDASHBOARD_MY_GROUPS_TITLE'); ?></span>
			</span>
				<?php if ($result['totalCount'] > $no_of_groups):	?>
				<a href="<?php echo $result['viewAll'] ?>" id="view-all-group-link" class="pull-right trigger" >
					<?php echo Text::_('PLG_TJLMSDASHBOARD_MY_GROUPS_VIEW_ALL_LABEL'); ?>
				</a>
			<?php endif; ?>
		...
		<div class="panel-body p-10">
			...
			<?php if ($result['totalCount'] == 0): ?>
					<div class="alert alert-warning">
						<?php echo Text::_('PLG_TJLMSDASHBOARD_MY_GROUPS_NO_GROUPS'); ?>
					</div>
			<?php else: ?>

			<?php

				foreach ($result['data'] as $ind => $group)
				{
					if($group->title){
				?>
						<div class="container-fluid">
							<div class="row your_each_group">
								...
								<a href="<?php echo $group->group_url; ?>" target="_blank"><?php echo $group->title; ?></a>
							</div>
						</div>
