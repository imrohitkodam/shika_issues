...
$lang->load('plg_tjlmsdashboard_completedcoursescount', JPATH_ADMINISTRATOR);
...
class PlgTjlmsdashboardCompletedcoursescount extends CMSPlugin
{
	/**
	 ...
	 * @since 1.0.0
	 */
	public function oncompletedcoursescountRenderPluginHTML($plg_data, $layout = 'default')
	{
		$completedCourses = $this->getData($plg_data);
	 ...
	 *
	 * @param   ARRAY  $plg_data  data to be used to completed courses count block
	 *
