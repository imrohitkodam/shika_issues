...
<div class="dashbs3 completed-courses-count statbox text-truncate mb-10 pb-10 <?php echo implode(' ', $class); ?>" data-toggle="tooltip" title="<?php echo Text::_('PLG_TJLMSDASHBOARD_COMPLETED_COURSE_COUNT_TOTALNUM'); ?>">
	<div class="statbox__label text-truncate" >
		<span><?php echo Text::_('PLG_TJLMSDASHBOARD_COMPLETED_COURSE_COUNT_TOTALNUM'); ?></span>
	</div>
