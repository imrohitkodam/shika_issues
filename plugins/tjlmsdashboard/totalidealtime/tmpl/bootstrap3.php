...
<div class="dashbs3 total-ideal-time statbox text-truncate mb-10 pb-10 <?php echo implode(' ', $class); ?>" data-toggle="tooltip" title="<?php echo Text::_('PLG_TJLMSDASHBOARD_TOTAL_IDEAL_TIME_NUM'); ?>">
