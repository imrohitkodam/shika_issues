...
class PlgTjlmsdashboardEnrolledcoursescount extends CMSPlugin
{
	/**
	 ...
	 * @since 1.0.0
	 */
	public function onenrolledcoursescountRenderPluginHTML($plg_data, $layout = 'default')
	{
		...
		$totalEnrolledCourses = $this->getData($plg_data);
