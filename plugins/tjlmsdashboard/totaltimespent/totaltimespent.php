...
$lang->load('plg_tjlmsdashboard_totaltimespent', JPATH_ADMINISTRATOR);
...
class PlgTjlmsdashboardTotaltimespent extends CMSPlugin
{
	/**
	 ...
	 * @since 1.0.0
	 */
	public function ontotaltimespentRenderPluginHTML($plg_data, $layout = 'default')
	{
		$totalSpentTime = $this->getData($plg_data);
	...
	public function getData($plg_data)
	{
		...
		$totalSpentTime = $tjlmsTrackingHelperObj->getTotalTimeSpent($plg_data->user_id);
