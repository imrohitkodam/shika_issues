...
class TjdashboardTableDashboards extends Table
{
	...
	public function delete($pk = null)
	{
		...
		catch (\Exception $e)
		{
			if ($e->getCode() === 1451)
			{
				throw new \RuntimeException(Text::_('COM_TJDASHBOARD_DASHBOARDS_DELETE_ERROR_MESSAGE'));
			}
			else
			{
				throw new \RuntimeException(Text::_('COM_TJDASHBOARD_DASHBOARD_DELETE_ERROR_MESSAGE_GENERAL'));
			}
		}
	}
}
