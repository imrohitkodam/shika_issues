 ...
 */
class TmtTableanswers extends Table {
    ...
    public function __construct(&$db) {
        parent::__construct('#__tmt_answers', 'id', $db);
    }
    ...
    public function bind($array, $ignore = '') {
		...
		if(($task == 'save' || $task == 'apply') && (!Factory::getUser()->authorise('core.edit.state','com_tmt') && $array['state'] == 1)){
			$array['state'] = 0;
		}
