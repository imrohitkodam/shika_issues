...
?>
<div id="tmt_question_form" class="row tjBs3">
		...
		<?php }?>
			...
			<form action="" method="post" name="adminForm" id="questionForm" class="form-validate main-card que-ans-form" enctype="multipart/form-data">
				...
				<div class="row">
							...
							<?php echo HTMLHelper::_('bootstrap.addTab', 'questionform', 'questionanswers', Text::_('COM_TMT_Q_FORM_ANSWERS', true)); ?>
								...
								<div data-js-id="for-mcqs">
									...
									<div class="row">
										...
										<div class="col-lg-2 font-600" data-js-id="answer-media">
										...
										<div class="col-lg-1 font-600" data-js-id="mcq-correct">
										...
										<div class="col-lg-1 font-600" data-js-type="quiz">
					...
					<div class="modal-footer fixed-bottom p-20">
							...
							<div class="btn-toolbar text-right clearfix" data-js-attr="form-actions">
								...
								<div id="toolbar-cancel" class="btn-wrapper tmt-cancel-btn">
