...
<div class="answer-template-text form-inline clearfix" id="answer-template-text<?php echo $i;?>">
	<div class="control-group" data-js-id="textinput-input">
		...
		<div class="controls">
			...
			<input type="text" name="answers_text[]" id="answers_text<?php echo $i;?>" class="inputbox required answers_text validate-blankspace" required="required" size="20" value="<?php echo htmlentities($answer->answer);?>"<?php echo $readOnly;?>/>
			<div class="pt-10">
				<em >
