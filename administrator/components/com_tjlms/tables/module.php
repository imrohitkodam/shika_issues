 ...
 * @since  1.0.0
 */
class TjlmsTablemodule extends Table
{
	/**
	 * Constructor
	 *
	...
	public function bind($array, $ignore = '')
	{
		...
		if (!Factory::getUser()->authorise('core.admin', 'com_tjlms.module.' . $array['id']))
		{
			$actions = Access::getActionsFromFile(
				JPATH_ADMINISTRATOR . '/components/com_tjlms/access.xml',
				"/access/section[@name='module']/"
			);
			
			$default_actions = Access::getAssetRules('com_tjlms.module.' . $array['id'])->getData();
			$array_jaccess = array();
