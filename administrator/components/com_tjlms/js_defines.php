...
var alert_confirm_proceed_deleting="<?php	echo Text::_('COM_TJLMS_SURE_DELETE')	?>";
var	delete_success_msg = "<?php	echo Text::_('COM_TJLMS_DELETE_SUCCESS')	?>";
var	lesson_delete_success_msg = "<?php	echo Text::_('COM_TJLMS_LESSON_DELETE_SUCCESS')	?>";
var	quiz_delete_success_msg = "<?php	echo Text::_('COM_TJLMS_QUIZ_DELETE_SUCCESS')	?>";
var	save_lesson_details_firstmsg = "<?php	echo Text::_('COM_TJLMS_SAVE_LESSON_DETAILS_BEFORE_FORMAT');?>"
var	format_not_uploaded_error = "<?php	echo Text::_('COM_TJLMS_FORMAT_NOT_UPLOADED_ERROR');?>";
var delete_lesson_msg	=	"<?php	echo Text::_('COM_TJLMS_SURE_DELETE')	?>";
var file_not_selected_error	= "<?php	echo Text::_('COM_TJLMS_FILE_NOT_SECLTED_ERROR')	?>";
