...
<form action="<?php echo Route::_('index.php?option=com_tjlms&layout=edit&id=' . (int) $this->item->id) ?>" method="post" enctype="multipart/form-data" name="adminForm" id="module-form" class="form-validate">
