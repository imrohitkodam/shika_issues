...
<div class="<?php echo COM_TJLMS_WRAPPER_DIV; ?>">
	...
	<form action="<?php echo JRoute::_('index.php?option=com_tjlms&view=activities'); ?>" method="post" name="adminForm" id="adminForm">
				...
				<thead>
					<tr>
						<th width="1%" class="nowrap center">
							<?php echo JText::_( 'COM_TJLMS_ACTIVITY_TEXT'); ?>
						</th>
					</tr>
				</thead>
				<tfoot>
