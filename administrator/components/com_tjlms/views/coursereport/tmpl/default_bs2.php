...
<form action="<?php echo JRoute::_('index.php?option=com_tjlms&view=coursereport'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<table class="table table-striped left_table" id="usersList">
		<thead>
			<tr>
				...
				<th class='left'>
					<?php echo JHtml::_('grid.sort',  'COM_TJLMS_COURSE_NAME', 'c.title', $listDirn, $listOrder); ?>
				</th>
				...
				<th class='left'>
					<?php echo JHtml::_('grid.sort',  'COM_TJLMS_ACL_GROUP', 'access_level_title', $listDirn, $listOrder); ?>
				</th>

				<th class='left'>
					<?php echo JHtml::_('grid.sort',  'COM_TJLMS_COURSE_TYPE', 'c.type', $listDirn, $listOrder); ?>
				</th>

				<th class='left'>
					<?php echo JHtml::_('grid.sort',  'COM_TJLMS_LESSONS_CNT', 'COUNT(l.id)', $listDirn, $listOrder); ?>
				</th>

				<th class='left'>
					<?php echo JHtml::_('grid.sort',  'COM_TJLMS_ENROLLED_USERS_CNT', 'enrolled_users', $listDirn, $listOrder); ?>
				</th>

				<th class='left'>
					<?php echo JHtml::_('grid.sort',  'COM_TJLMS_PENDING_ENROLLED_USERS_CNT', 'pending_enrollment', $listDirn, $listOrder); ?>
				</th>

				<th class='left'>
					<?php echo JHtml::_('grid.sort',  'COM_TJLMS_COMPLETED_USERS_CNT', 'totalCompletedUsers', $listDirn, $listOrder); ?>
				</th>

				<th class='left'>
					<?php echo JHtml::_('grid.sort',  'COM_TJLMS_LIKES_CNT', 'likeCnt', $listDirn, $listOrder); ?>
				</th>

				<th class='left'>
					<?php echo JHtml::_('grid.sort',  'COM_TJLMS_DISLIKES_CNT', 'dislikeCnt', $listDirn, $listOrder); ?>
				</th>

				<th class='left'>
					<?php echo JHtml::_('grid.sort',  'COM_TJLMS_COMMENTS_CNT', 'commnetsCnt', $listDirn, $listOrder); ?>
				</th>

				<th class='left'>
					<?php echo JHtml::_('grid.sort',  'COM_TJLMS_RECO_CNT', 'recommendCnt', $listDirn, $listOrder); ?>
				</th>

				<th class='left'>
					<?php echo JHtml::_('grid.sort',  'COM_TJLMS_ASSIGN_CNT', 'assignCnt', $listDirn, $listOrder); ?>
				</th>

				<th class='left'>
					<?php echo JHtml::_('grid.sort',  'COM_TJLMS_COURSE_ID', 'c.id', $listDirn, $listOrder); ?>
				</th>
		...
		<?php foreach ($this->items as $i => $item) : ?>
			<tr class="row<?php echo $i % 2; ?>">
				<td class="center hidden-phone" style="<?php echo $displayToggel; ?>">
					<?php echo JHtml::_('grid.id', $i, $item->course_id); ?>
				</td>
