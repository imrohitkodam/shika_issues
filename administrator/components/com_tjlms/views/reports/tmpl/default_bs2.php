...
$document->addScript(JURI::base(true).'/components/com_tjlms/assets/js/jquery.twbsPagination.js');
...
<div class="<?php echo COM_TJLMS_WRAPPER_DIV ?>">
		...
		<form action="<?php echo JRoute::_('index.php?option=com_tjlms&view=reports'); ?>" method="post" name="adminForm" id="adminForm">
			<div class="report-top-bar row-fluid">
				<?php if (empty($this->items)): ?>
					<div class="alert alert-warning">
						<?php echo JText::_('COM_TJLMS_NO_REPORT'); ?>
					</div>
				<?php else: ?>
			...
			<div class="span6">
				<div class="span12">
					<div class="show-hide-cols span6">
						<input type="button" id="show-hide-cols-btn" class="btn btn-success" onclick="getColNames(); return false;" value="<?php echo JText::_('COM_TJLMS_HIDE_SHOW_COL_BUTTON'); ?>"></button>
			...
			<div class="span6">
				<div class="span12">
					<div class="hide" id="queryName" >
						<input type="text" class="input-medium" name="queryName" placeholder="<?php echo JText::_('COM_TJLMS_TITLE_FOR_QUERY'); ?>"/>
					</div>

					<div class="span9" id="saveQuery">
						<input type="button" class="btn btn-primary pull-right" id="saveQuery" onclick="saveThisQuery();" value="<?php echo JText::_('COM_TJLMS_SAVE_THIS_QUERY'); ?>" />
					</div>
...
jQuery(document).ready(function()
{
	...
	jQuery('.ColVis_collection input').click(function(){
		...
		{
			var msg = Joomla.JText._('COM_TJLMS_REPORTS_CANNOT_SELECT_NONE');
			alert(msg);
			return false;
		}
	});
