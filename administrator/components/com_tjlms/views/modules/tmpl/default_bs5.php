...
<div class="<?php echo COM_TJLMS_WRAPPER_DIV ?>">
	...
	?> <!--// JHtmlsidebar for menu ends-->
		...
		<div class="modal d-none fade" id="tjlmsModal">
		...
		<?php }else { ?>
			...
			<?php
				...
				{
					$toolsLink = Route::_("index.php?option=com_tjlms&view=tools&course_id=" . $this->CourseInfo->id);
				?>
			...
			<div class="add-module-div" data-js-id="edit-module">
				<img alt="Add module" src="<?php echo Uri::root(true).'/media/com_tjlms/images/default/icons/add-module.png'; ?>"  title="<?php echo Text::_('COM_TJLMS_ADD_MULTIPLE_LESSONS');	?>"/>
