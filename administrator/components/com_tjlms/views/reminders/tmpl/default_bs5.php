...
$document->addStyleSheet(Uri::root() . 'media/com_tjlms/css/list.css');
...
<form action="<?php echo Route::_('index.php?option=com_tjlms&view=reminders'); ?>" method="post"
	...
	<?php echo HTMLHelper::_('grid.sort', 'JSTATUS', 'a.`state`', $listDirn, $listOrder); ?>
					...
					<?php endif; ?>
									...
									<th class='left'>
				<?php echo HTMLHelper::_('grid.sort',  'COM_TJLMS_REMINDERS_ID', 'a.`id`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo HTMLHelper::_('grid.sort',  'COM_TJLMS_REMINDERS_TITLE', 'a.`title`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo HTMLHelper::_('grid.sort',  'COM_TJLMS_REMINDERS_DESCRIPTION', 'a.`description`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo HTMLHelper::_('grid.sort',  'COM_TJLMS_REMINDERS_DAYS', 'a.`days`', $listDirn, $listOrder); ?>
				</th>
	...
	<?php echo HTMLHelper::_('jgrid.published', $item->state, $i, 'reminders.', $canChange, 'cb'); ?>
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo Route::_('index.php?option=com_tjlms&task=reminder.edit&id='.(int) $item->id); ?>">
