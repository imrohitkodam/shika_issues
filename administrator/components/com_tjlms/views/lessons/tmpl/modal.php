...
/** @var \Joomla\Component\Content\Administrator\Model\ArticlesModel $articlesModel */
$articlesModel = $factory->createModel('Articles', 'Administrator', ['ignore_request' => true]);
$articlesModel->setState('list.start', 0);
$articlesModel->setState('list.ordering', 'a.hits');
$articlesModel->setState('list.direction', 'DESC');
$this->items = $articlesModel->getItems();
            ...
            <table class="table table-sm">
                ...
                <?php foreach ($this->items as $i => $item) : ?>
                    ...
                    <tr class="row<?php echo $i % 2; ?>">
                        ...
                        <th scope="row">
                            <?php  
                            $articleUrl = $this->escape(RouteHelper::getArticleRoute($item->id, $item->catid, $item->language));
                            ...
                            ?>
                            <a class="select-link" href="javascript:validArticle(<?php echo $item->id; ?>,'<?php echo $item->title; ?>',<?php echo $item->catid; ?>,'<?php echo $lang; ?>','<?php echo $articleUrl; ?>')" <?php echo $attribs; ?>>
