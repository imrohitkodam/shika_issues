	...
	<?php if (empty($this->items)) : ?>
		...
		<table class="table table-striped tjlms-filedownloadstats-table" id="fileDownloadStatsList">
			...
			<?php foreach ($this->items as $i => $item) :
				$userTimeStats = 'index.php?option=com_tjlms&view=filedownloadstats&layout=modal&tmpl=component&fileId=' . $item->file_id;
				?>
				<tr class="row<?php echo $i % 2; ?>">
					...
					<td>
						<a title="<?php echo JText::_( 'COM_TJLMS_FILE_DOWNLAOD_STATS_INFO' ); ?> " onclick="opentjlmsSqueezeBox('<?php echo $userTimeStats; ?>', 1);" class="modal <?php echo $InactiveBtn; ?>">
