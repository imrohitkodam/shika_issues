		...
		<table class="table table-striped tjlms-order-table" id="orderList">
			...
			<?php foreach ($this->items as $i => $item) :
				...
				<?php endif; ?>
					...
					<a onclick="opentjlmsSqueezeBox('<?php echo JUri::root();?>', 'addModal', <?php echo $item->id;?>); jQuery('#addModal').removeClass('hide')" ><?php if($item->order_id) echo $item->order_id; else echo $item->id;?></a>
