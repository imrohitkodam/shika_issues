...
<form action="<?php echo Route::_('index.php?option=com_tjlms&view=certificates'); ?>" method="post"
			...
			<table class="table table-striped" id="certificatetemplateList">
				...
				<tr>
					...
					<?php endif; ?>
									...
									<th class='left'>
				<?php echo HTMLHelper::_('grid.sort',  'COM_TJLMS_CERTIFICATES_ID', 'a.id', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo HTMLHelper::_('grid.sort',  'COM_TJLMS_CERTIFICATES_TITLE', 'a.title', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo HTMLHelper::_('grid.sort',  'COM_TJLMS_CREATOR', 'a.created_by', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo HTMLHelper::_('grid.sort',  'COM_TJLMS_CERTIFICATES_CREATED_DATE', 'a.created_date', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo HTMLHelper::_('grid.sort',  'COM_TJLMS_CERTIFICATES_MODIFIED_DATE', 'a.modified_date', $listDirn, $listOrder); ?>
				</th>
				</tr>
				</thead>
				<tfoot>
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo Route::_('index.php?option=com_tjlms&task=certificatetemplate.edit&id='.(int) $item->id); ?>">
