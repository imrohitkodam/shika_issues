...
<form action="<?php echo JRoute::_('index.php?option=com_tjlms&view=studentcoursereport'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<table class="table table-striped left_table" id="usersList">
		<thead>
			<tr>
				...
				<th class='left'>
					<?php echo JHtml::_('grid.sort',  'COM_TJLMS_FORM_LBL_COURSE_CERTIFICATE_TERM', 'certificate_term', $listDirn, $listOrder); ?>
				</th>
				...
				<th class='left'>
					<?php echo JHtml::_('grid.sort',  'COM_TJLMS_REPORT_USERNAME', 'user_name', $listDirn, $listOrder); ?>
				</th>
				...
				<th class='left'>
					<?php echo JHtml::_('grid.sort',  'COM_TJLMS_REPORT_USEREMAIL', 'useremail', $listDirn, $listOrder); ?>
				</th>

				<th class='left'>
					<?php echo JHtml::_('grid.sort',  'COM_TJLMS_USER_END_DATE', 'eu.end_time', $listDirn, $listOrder); ?>
				</th>
				...
				<th class='left'>
					<?php echo JHtml::_('grid.sort',  'COM_TJLMS_COURSE_ID', 'eu.course_id', $listDirn, $listOrder); ?>
				</th>
