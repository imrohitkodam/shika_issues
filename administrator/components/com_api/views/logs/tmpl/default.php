...
HTMLHelper::addIncludePath($componentPath . '/helpers/html');
...
<div class="<?php echo COM_APIS_WRAPPER_CLASS; ?> api-logs">
	<form
		action="<?php echo Route::_('index.php?option=com_api&view=logs'); ?>"
		...
		<?php else : ?>
			...
			<div id="filter-bar" class="btn-toolbar">
				<div class="filter-search btn-group pull-left">
					...
					placeholder="<?php echo Text::_('COM_API_LOGS_SEARCH_FILTER'); ?>"
					value="<?php echo $this->escape($this->state->get('filter.search')); ?>"
					class="hasTooltip"
					title="<?php echo Text::_('COM_API_LOGS_SEARCH_FILTER'); ?>" />
				</div>
				...
				<thead>
					<tr>
						...
						<th class='left' width="10%">
							...
							<?php echo HTMLHelper::_('grid.sort',  'COM_API_LOGS_USER', 'u.name', $listDirn, $listOrder); ?>
						</th>
						<th class='left'>
							<?php echo HTMLHelper::_('grid.sort',  'COM_API_LOGS_IP_ADDRESS', 'a.ip_address', $listDirn, $listOrder); ?>
						</th>
						<th class='left'>
							<?php echo HTMLHelper::_('grid.sort',  'COM_API_LOGS_TIME', 'a.time', $listDirn, $listOrder); ?>
						</th>
						<th class='left'>
							<?php echo HTMLHelper::_('grid.sort',  'COM_API_LOGS_REQUEST_METHOD', 'a.request_method', $listDirn, $listOrder); ?>
						</th>
						<th class='left' width="15%"><?php echo Text::_('COM_API_LOGS_REQUEST'); ?></th>
						<th class='left' width="25%"><?php echo Text::_('COM_API_LOGS_POST_DATA'); ?></th>
					</tr>
				</thead>
					...
					<?php foreach ($this->items as $i => $item) : ?>
						<tr class="row<?php echo $i % 2; ?>">
							...
							<td>
								...
								<?php else : echo Text::_('UNASSIGNED_HASH'); ?>
								<?php endif; ?>
							<td>
