...
class Com_TjcertificateInstallerScript
{
	...
	{
		// Check if TJNotifications component is installed
		if (!file_exists(JPATH_ADMINISTRATOR . '/components/com_tjnotifications/models'))
		{
			return;
		}
		...
		// Ensure existingKeys is an array
