...
class TjCertificateControllerTrainingRecord extends FormController
{
	...
	public function deleteAttachment()
	{
		...
		if ($result)
		{
			echo new JsonResponse($result, Text::_('COM_TJCERTIFICATE_ATTACHMENT_DELETED_SUCCESSFULLY'), false);
			$app->close();
		}
		else
		{
			echo new JsonResponse(null, Text::_('COM_TJCERTIFICATE_ATTACHMENT_DELETED_FAILED'), true);
			$app->close();
		}
	}
